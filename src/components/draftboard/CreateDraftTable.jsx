...
const draft = [
  {round:'Round1', draftPicks:[
    ...
    {pickNumber: '1.08', ownerName: 'Jensen', playerSelected: 'Noah Fant', playerPosition: 'TE'},
    {pickNumber: '1.09', ownerName: 'Jordan', playerSelected: 'Deebo Samuel', playerPosition: 'WR'},
    {pickNumber: '1.10', ownerName: 'Austin', playerSelected: 'D.K. Metcalf', playerPosition: 'WR'},
